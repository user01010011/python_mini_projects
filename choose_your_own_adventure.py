...
answer = input("You are on a road, it has come to an end and you can go left or right. Which way would you like to go? left/right ").lower()
if answer == "left":
    ...
    if answer == "back":
        ...
        if answer == "yes": 
            ...
            print("You ignore the stranger and did not get the gold. You lose.")
        else:
